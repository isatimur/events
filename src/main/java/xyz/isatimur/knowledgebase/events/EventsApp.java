package xyz.isatimur.knowledgebase.events;

import xyz.isatimur.knowledgebase.events.config.ApplicationProperties;
import xyz.isatimur.knowledgebase.events.config.DefaultProfileUtil;
